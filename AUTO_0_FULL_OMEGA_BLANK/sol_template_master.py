...
auto_setup = False  # automatically creates modules that will be imported plugged in and ready to use.
auto_generate = False  # creates objects automatically using values below.
...
auto_title_bar_toolbar = False  # enables automatically created title area toolbar.
...
configuration_override_size = True  # enables app_width_static and app_height_static to be set manually, else application will automatically fit to object geometry
...
reserve_btnx_double = [0, 2, 4, 6, 8, 10, 12, 24, 36, 48, 60, 72, 82, 22, 34, 46, 58, 70, 72, 74, 76, 78, 80]  # reserve objects for any reason, like a menu.
